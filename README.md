...
Sites should be useable for individuals with disabilities, which means taking a lot of different situtions into consideration. Short-term or permanent disability, color blindness, autism, and similar factors can be accounted for when creating web page, to ensure that everyone gets a good experience on the page. This often benefits all users. 
...
A variable is a way to store and reference information.

4. What is the purpose of using functions in code?
Functions allow for grouping of tasks related to achieving a goal, and then only calling that function when it is required. 
